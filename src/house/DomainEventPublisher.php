...
use App\house\persistence\inMemory\DomainEventProducerInMemory;
...
class DomainEventPublisher extends EventDispatcher
{
    ...
    public static function instance(): DomainEventPublisher {
        if (self::$instance == null)
        {
            ...
            self::$instance->addSubscriber(new EventForwardingService(new DomainEventProducerInMemory(EventBusInMemory::instance())));
        }
